...
@Composable
fun ClientNavGraph(navController: NavHostController, paddingValues: PaddingValues, uiSettings: MutableState<UiSettings>) {
    NavHost(navController = navController, startDestination = ClientBottomMenuItem.Home.screen_route) {
        ...
        composable(ClientBottomMenuItem.Chat.screen_route) {
...
sealed class ClientBottomMenuItem(var title: String, var icon: Int, var screen_route: String){
    ...
    object Workouts :
        ClientBottomMenuItem("Тренировки", R.drawable.baseline_work_24, "workouts")
    object Chat :
